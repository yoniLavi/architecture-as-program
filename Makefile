...
.PHONY: build clean validate-graphs test wasm check-freeze grammar evaluation paper1 paper2 aliases api ui ui-check ui-e2e
...
# ── Output directories ──────────────────────────────────────────────
$(DIST) $(DIST)/graphs $(DIST)/diagrams $(DIST)/ui $(P1_OUT) $(P1_OUT)/graphs $(P1_OUT)/diagrams $(P2_OUT):
	mkdir -p $@
