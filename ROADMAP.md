...
| **A contract language** | Deliberately minimal: pre/postconditions over declared types, checked by property-based testing | Prerequisite for the generation experiment below. Scope it to the agenda's "shallow verification" bound — not refinement types, not Dafny |
